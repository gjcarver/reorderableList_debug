...
void main() => runApp(const HelpTools());
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      // Remove the debug banner
        ...
        title: 'N4O Workflow Tool: Tools Help',
        theme: ThemeData(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        //     home: Scaffold(
        //       appBar: AppBar(
        title: const Text('N4O Workflow Tool: Tools Help'),
