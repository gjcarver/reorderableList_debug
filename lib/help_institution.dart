...
void main() => runApp(const HelpInstitution());

class HelpInstitution extends StatelessWidget {
  const HelpInstitution({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        //     home: Scaffold(
        //       appBar: AppBar(
        title: const Text('N4O Workflow Tool: Institution Help'),
      ...
      body: const Center(child: Text('Temporary Institution Help Page')),
            ...
            case 0:
              {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const InstitutionForm()),
                );
                setState(() {
                  compoundIndex = 0;
                });
