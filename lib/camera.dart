...
class PhotosVideo extends StatefulWidget {
  /// Default Constructor
  const PhotosVideo({super.key});

  @override
  State<PhotosVideo> createState() {
    return _PhotosVideoState();
  }
}
...
class _PhotosVideoState extends State<PhotosVideo>
