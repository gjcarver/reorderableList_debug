...
import '/flowchart_editor/widget/component/base_component_body.dart';
import 'package:flutter/material.dart';

class DecisionBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseComponentBody(
      ...
      componentPainter: DecisionPainter(
...
class DecisionPainter extends CustomPainter {
  final Color color;
